...
namespace project {
  struct asset_serializer {
    PROJECT_INLINE asset_serializer(asset_registry* assets): _assets(assets) {}
    ...
    PROJECT_INLINE void deserialize(YAML::Node& nodes, SDL_Renderer* r) {
      // clear registry
      _assets->clear();
    ...
    PROJECT_INLINE void serialize_textures(YAML::Emitter& em) {
    ...
    PROJECT_INLINE void deserialize_texture(YAML::Node node, SDL_Renderer* target) {
    ...
    PROJECT_INLINE void serialize_animations(YAML::Emitter& em) {
    ...
    PROJECT_INLINE void deserialize_animation(YAML::Node node) {
    ...
    PROJECT_INLINE void serialize_audios(YAML::Emitter& em) {
    ...
    PROJECT_INLINE void deserialize_audio(YAML::Node node) {
    ...
    PROJECT_INLINE void serialize_fonts(YAML::Emitter& em) {
    ...
    PROJECT_INLINE void deserialize_font(YAML::Node node) {
